...
export async function removeMatch(userid: string, friendid: string, next: NextFunction) {
...
export async function removeChat(id1: string, id2: string) {
  try {
...
export async function removeChatFromUser(userid: string, chatid: string) {
  try {
